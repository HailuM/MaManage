...
import com.langchao.mamanage.utils.JsonUtils;


import java.io.UnsupportedEncodingException;

/**
 * 小Created by Administrator on 2015/3/11.
 */
@SuppressLint("NewApi")
public class RequestManager {
    ...
    public static void get(String url, Object tag, String progressTitle,
        ...
        dialog.createLoadingDialog((Context) tag, progressTitle).show();
        ByteArrayRequest request = new ByteArrayRequest(Request.Method.GET,
    ...
    public static <T> void get(String url, Object tag, Class<T> classOfT,
        ...
        ByteArrayRequest request = new ByteArrayRequest(Request.Method.GET,
                ...
                dialog), responseError(listener, LoadingShow, dialog));
        addRequest(request, tag);
    }
    ...
    protected static <T> Response.Listener<byte[]> responseListener(
            ...
            final boolean flag, final LoadingDialog dialog) {
