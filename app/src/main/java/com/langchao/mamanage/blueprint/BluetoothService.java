...
public class BluetoothService {  
    ...
    private BluetoothAdapter bluetoothAdapter = BluetoothAdapter  
            .getDefaultAdapter();  
    private ArrayList<BluetoothDevice> unbondDevices = null; // 用于存放未配对蓝牙设
    private ArrayList<BluetoothDevice> bondDevices = null;// 用于存放已配对蓝牙设
  ...
  public BluetoothService(Context context, ListView unbondDevicesListView,  
          ListView bondDevicesListView, Button switchBT, Button searchDevices,String name) {  
        ...
        this.bondDevicesListView  
                .setOnItemClickListener(new OnItemClickListener() {  
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1,  
						...
						BluetoothActivity activy=new BluetoothActivity();
                        Intent intent = new Intent();  
                        Bundle bundle=new Bundle();
                     //  String namezl= intent.getStringExtra("xians");
                       intent.putExtra("xians", cznum);
       	            
       				
       	               
       	               intent.putExtras(bundle );
                        intent.setClassName(context,  
                                "com.ntzn.blueprint.PrintDataActivity");  
                       // intent.setClassName(BluetoothService.this,PrintDataActivity.class);  
