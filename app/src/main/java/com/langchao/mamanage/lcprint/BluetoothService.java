...
public class BluetoothService {
        ...
        this.bondDevicesListView  
                .setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1,
                        ...
                        intent2.setClassName(context,
                                "com.langchao.mamanage.lcprint.PrintDataActivity");
                        intent2.putExtra("printdata", intent.getStringExtra("printdata"));
    ...
    public BluetoothService(Context context, ListView unbondDevicesListView,  
            ListView bondDevicesListView, Button switchBT, Button searchDevices,Intent intent) {
